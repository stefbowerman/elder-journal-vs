...
function elder_scripts() {
  ...
  wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/libs/modernizr.custom.min.js', array(), false, false );
...
function elder_paging_nav(){
  ...
  posts_nav_link( '<div class="post-siblings-link-separator"></div>', '<div class="post-siblings-link-prev">Back</div>', '<div class="post-siblings-link-next">Next</div>' );
  echo '</div>';
...
function elder_post_siblings_links(){
  if(get_previous_post_link() || get_next_post_link()) {
      echo '<div class="post-siblings-links">';
      previous_post_link('<div class="post-siblings-link-prev">%link</div>', 'Back');
      if(get_previous_posts_link() && get_next_posts_link()) {
       echo '<div class="post-siblings-link-separator"></div>'; 
      }
      next_post_link('<div class="post-siblings-link-next">%link</div>', 'Next');
      echo '</div>';
    }
  }
